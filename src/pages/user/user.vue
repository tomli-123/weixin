<template>
  <view class="wrapper">
    ...
    <view class="orders">
      ...
      <view class="sorts">
        <navigator url="/pages/order/order?id=1" class="icon-list">全部</navigator>
        <navigator url="/pages/order/order?id=2" class="icon-bill">待付款</navigator>
        <navigator url="/pages/order/order?id=3" class="icon-car">待收货</navigator>
        <navigator url="/pages/order/order?id=4" class="icon-money">退款/退货</navigator>
      </view>
    </view>
    <!-- 地址管理 -->
